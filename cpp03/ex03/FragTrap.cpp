...
/*   Updated: 2022/07/30 16:15:37 by sghajdao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(std::string name): ClapTrap(name)
{
    ...
    this->attack_d = 30;
    //this->name = name;
    std::cout << "the FragTrap " << this->name << "[ hit points(100) , energy points(100) , attack damage (30) ] \033[0;32mstart!\033[0m" << std::endl;
}
